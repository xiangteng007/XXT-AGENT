...
XXT-AGENT 專家委員會由 **105 位專家** 組成，涵蓋 **12 大領域**，為系統運營與用戶服務提供全方位專業支援。
...
| **H15** | Emergency Physician / 急診醫學專家 | 急診處置、創傷評估、急性中毒、休克/心跳停止急救 |
| **H16** | EMT / Paramedic Officer / 緊急救護技術員 | OHCA/AED、氣道管理、止血包紮、頸椎固定、搬運轉送 |
| **H17** | Mass Casualty Triage Specialist / 大量傷患檢傷分類專家 | START/JumpSTART 檢傷、傷患分流、醫療站設置、資源調度 |
| **H18** | Tactical Combat Casualty Care (TCCC) / 戰術戰傷救護專家 | 戰場止血(CAT/TQ)、張力性氣胸處理、低體溫防治、傷患後送 |
| **H19** | Disaster Medical Coordinator / 災難醫療協調官 | 災害醫療應變、DMAT 編組、野外醫療站、跨機構醫療資源整合 |
...
| v2.3 | 2026-02-10 | 新增 5 位緊急救護/戰地醫療專家 (H15-H19)，總計 105 位專家 |

---

## 狀態標語

> ✅ **XXT-AGENT 系統憲法 v2.3 已正式生效。105 位專家委員會已就位，涵蓋 12 大領域。LINE Bot 與 Telegram Bot 雙通道整合完成。**
