...
exports.SUPPORTED_MODELS = exports.DEFAULT_MODEL = exports.PROJECT_ID = void 0;
exports.getModelsByProvider = getModelsByProvider;
exports.getActiveModels = getActiveModels;
exports.PROJECT_ID = process.env.GOOGLE_CLOUD_PROJECT || 'xxt-agent';
exports.DEFAULT_MODEL = 'gemini-2.5-flash-preview-05-20';
/**
...
function getModelsByProvider(provider) {
    return Object.fromEntries(Object.entries(exports.SUPPORTED_MODELS).filter(([, info]) => info.provider === provider));
}
/**
 * Get all non-deprecated models
 */
function getActiveModels() {
    return Object.fromEntries(Object.entries(exports.SUPPORTED_MODELS).filter(([, info]) => !info.deprecated));
}
