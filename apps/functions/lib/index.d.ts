...
export declare const newsCollectorScheduled: import("firebase-functions/v2/scheduler").ScheduleFunction;
export declare const newsCollector: import("firebase-functions/v2/https").HttpsFunction;
