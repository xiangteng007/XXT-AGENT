...
exports.TRANSACTION_CATEGORIES = exports.TAIWAN_BANKS = void 0;
exports.getBankConfig = getBankConfig;
exports.getSupportedBankCodes = getSupportedBankCodes;
...
function getBankConfig(bankCode) {
    return exports.TAIWAN_BANKS[bankCode];
}
/**
 * Get all supported bank codes
 */
function getSupportedBankCodes() {
    return Object.keys(exports.TAIWAN_BANKS);
}
//# sourceMappingURL=bank-config.js.map