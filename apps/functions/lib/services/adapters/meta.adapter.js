...
exports.createFacebookAdapter = createFacebookAdapter;
exports.createInstagramAdapter = createInstagramAdapter;
exports.createThreadsAdapter = createThreadsAdapter;
    ...
    return {
        ...
        mapToNormalized(item, source) {
            ...
            return {
                ...
                severity: 10,
                entities: [],
                dedupHash: (0, social_collector_service_1.generateDedupHash)(content, post.permalink_url || '', createdAt),
                rawRef: item,
                insertedAt: new Date(),
            };
        },
    ...
    return {
        ...
        mapToNormalized(item, source) {
            ...
            return {
                ...
                severity: 10,
                entities: [],
                dedupHash: (0, social_collector_service_1.generateDedupHash)(content, media.permalink, createdAt),
                rawRef: item,
                insertedAt: new Date(),
            };
        },
    ...
    return {
        ...
        mapToNormalized(item, source) {
            ...
            return {
                ...
                severity: 10,
                entities: [],
                dedupHash: (0, social_collector_service_1.generateDedupHash)(content, post.permalink || '', createdAt),
                rawRef: item,
                insertedAt: new Date(),
            };
        },
