...
const GeminiResponseSchema = zod_1.z.object({
    severity: zod_1.z.number().min(0).max(100),
    sentiment: zod_1.z.enum(['positive', 'negative', 'neutral']),
    keywords: zod_1.z.array(zod_1.z.string()).max(10),
    entities: zod_1.z.array(zod_1.z.object({
        type: zod_1.z.enum(['ticker', 'fund', 'future', 'topic', 'location', 'person', 'org']),
        value: zod_1.z.string(),
    })).max(10),
    impactHint: zod_1.z.string(),
 ...
 */
async function enrichWithGemini(request) {
 ...
 */
function fallbackValidation(partial) {
    return {
...
function validateEntities(entities) {
    if (!Array.isArray(entities))
        return [];
    return entities
        .filter((e) => e !== null && typeof e === 'object' && 'type' in e && 'value' in e)
        .map(e => ({
...
//# sourceMappingURL=gemini-enricher.service.js.map