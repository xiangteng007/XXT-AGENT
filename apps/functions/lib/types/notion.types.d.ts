...
export type NotionPropertyValue = NotionTitleProperty | NotionRichTextProperty | NotionSelectProperty | NotionMultiSelectProperty | NotionDateProperty | NotionStatusProperty | NotionNumberProperty | NotionCheckboxProperty | NotionUrlProperty | NotionEmailProperty | NotionFilesProperty;
...
export type NotionPropertyType = 'title' | 'rich_text' | 'select' | 'multi_select' | 'status' | 'date' | 'number' | 'checkbox' | 'url' | 'email' | 'phone_number' | 'formula' | 'relation' | 'rollup' | 'created_time' | 'created_by' | 'last_edited_time' | 'last_edited_by' | 'files' | 'people';
