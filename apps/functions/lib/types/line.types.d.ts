...
export type LineEvent = LineMessageEvent | LineFollowEvent | LineUnfollowEvent | LineJoinEvent | LineLeaveEvent;
...
export type LineEventSource = LineUserSource | LineGroupSource | LineRoomSource;
...
export type LineMessage = LineTextMessage | LineImageMessage | LineLocationMessage | LineStickerMessage;
...
export type LineSendMessage = LineTextSendMessage | LineFlexSendMessage;
